...
if (nowDay===12 && nowMonth===8) {
  ...
  frameContainer.style.setProperty("margin-top", "0");
  frameContainer.style.setProperty("box-shadow","0 0 120px wheat");
}
else{
  const fireworksContainer = document.getElementById("fireworks");
  fireworksContainer.style.setProperty("height", "0");
}
